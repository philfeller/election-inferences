---
title: "Connecticut Party Transitions: 1851-1857"
...
knitr::kable(kable.52,
  format = "html", caption = "Table 1: Estimated Voter Transitions from 1851 to 1852") %>%
  kableExtra::column_spec(1, bold = TRUE) %>%
  kableExtra::kable_styling(full_width = FALSE)
knitr::kable(kable.53,
  format = "html", caption = "Table 2: Estimated Voter Transitions from 1852 to 1853") %>%
  kableExtra::column_spec(1, bold = TRUE) %>%
  kableExtra::kable_styling(full_width = FALSE)
knitr::kable(kable.54,
  format = "html", caption = "Table 3: Estimated Voter Transitions from 1853 to 1854") %>%
  kableExtra::column_spec(1, bold = TRUE) %>%
  kableExtra::kable_styling(full_width = FALSE)
knitr::kable(kable.55,
  format = "html", caption = "Table 4: Estimated Voter Transitions from 1854 to 1855") %>%
  kableExtra::column_spec(1, bold = TRUE) %>%
  kableExtra::kable_styling(full_width = FALSE)
knitr::kable(kable.56,
  format = "html", caption = "Table 5: Estimated Voter Transitions from 1855 to 1856") %>%
  kableExtra::column_spec(1, bold = TRUE) %>%
  kableExtra::kable_styling(full_width = FALSE)
knitr::kable(kable.57,
  format = "html", caption = "Table 6: Estimated Voter Transitions from 1856 to 1857") %>%
  kableExtra::column_spec(1, bold = TRUE) %>%
  kableExtra::kable_styling(full_width = FALSE)