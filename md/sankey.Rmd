...
Transitions less than 0.5% are not shown. Hover over the flows to see exact percentages and 95% confidence intervals; hover over the nodes to see total percentages for each party in a given year
